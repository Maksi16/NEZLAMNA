  ...
  const reportsData = [
    ...
    {
        "name": "2022-03-19_Амініція для ТРО-Київ.JPG",
        "text": "Амуніція для ТРО. Київ, 2022-03-19."
    },
    {
        "name": "2022-03-19_Екіпірування для ЗСУ-Київ.JPG",
    ...
    {
        "name": "2022-03-25_Екіпіровка для ЗСУ-Київ.JPG",
    ...
    {
        "name": "2022-04-01_Бронежилет для ЗСУ-Київ.JPG",
        "text": "Бронежилет для ЗСУ. Київ, 2022-04-01."
    },
    {
        "name": "2022-04-02_Бронежилет для ЗСУ-Київ.JPG",
    ...
    {
        "name": "2022-04-09_Амуніція для ЗСУ-Харків-Миколаїв.JPG",
        "text": "Амуніція для ЗСУ. Харків, Миколаїв, 2022-04-09."
    },
    {
        "name": "2022-04-10_Бронежилети для бійців АЗОВ.JPG",
    ...
    {
        "name": "2022-04-11_Амуніція для ЗСУ-Київ.JPG",
        "text": "Амуніція для ЗСУ. Київ, 2022-04-11."
    },
    {
        "name": "2022-04-11_Амуніція та їжа для ЗСУ-Донецька обл..JPG",
    ...
    {
        "name": "2022-04-15_Амуніція для ЗСУ-Київ.JPG",
    ...
    {
        "name": "2022-04-17_Амуніція та їжа  для ЗСУ.JPG",
    ...
    {
        "name": "2022-04-23_Амуніція  та турнікети для  ЗСУ-Миколаїв.JPG",
    ...
    {
        "name": "2022-05-11_Амуніція для ЗСУ-Миколаїв.JPG",
    ...
    {
        "name": "2022-05-24_Їжа для в_ч а7372, бригади 25 та 93.JPG",
    ...
    {
        "name": "2022-06-03_Їжа для в_ч а7372, бригади 25 та 93.JPG",
    ...
    {
        "name": "2022-06-11_Медикаменти для військових-Південь_.JPG",
        "text": "Медикаменти для військових. Південь, 2022-06-11."
    },
    {
        "name": "2022-06-11_Медикаменти для військових-Південь.JPG",
        "text": "Медикаменти для військових. Південь, 2022-06-11."
    },
    {
    ...
    {
        "name": "2022-06-14_Медикаменти для 17 танкової бригади.JPG",
        "text": "Медикаменти для 17 танкової бригади. 2022-06-14."
    },
    {
        "name": "2022-06-14_Медикаменти для 17 танкової бригади1.JPG",
        "text": "Медикаменти для 17 танкової бригади. 2022-06-14."
    },
    {
        "name": "2022-06-15_Фляги для 65 артилерійної бригади.JPG",
    ...
    {
        "name": "2022-06-28_Їжа для 80ДШБ-Донецька область.JPG",
        "text": "Їжа для 80ДШБ. Донецька область, 2022-06-28."
    },
    {
        "name": "2022-06-28_Їжа для 80ДШБ-Донецька область1.JPG",
        "text": "Їжа для 80ДШБ. Донецька область, 2022-06-28."
    },
    {
        "name": "2022-06-28_Їжа для 80ДШБ-Донецька область2.JPG",
        "text": "Їжа для 80ДШБ. Донецька область, 2022-06-28."
    },
    {
        "name": "2022-06-28_Їжа для 80ДШБ-Донецька область3.JPG",
        "text": "Їжа для 80ДШБ-Донецька область. 2022-06-28."
    },
    {
    ...
    {
        "name": "2022-06-30_2 дизельних генератори Gucbir CJD8000 H3 8, Інструменти (набір головок торцевих, викрутка з бітами, ключ розвідний), 2 Домкрати гідравлічні на 5т та Олива моторна Castrol для 2 стрілецького батальйону військової частини А1008__.JPG",
    ...
    {
        "name": "2022-06-30_2 дизельних генератори Gucbir CJD8000 H3 8, Інструменти (набір головок торцевих, викрутка з бітами, ключ розвідний), 2 Домкрати гідравлічні на 5т та Олива моторна Castrol для 2 стрілецького батальйону військової частини А1008_.JPG",
    ...
    {
        "name": "2022-06-30_2 дизельних генератори Gucbir CJD8000 H3 8, Інструменти (набір головок торцевих, викрутка з бітами, ключ розвідний), 2 Домкрати гідравлічні на 5т та Олива моторна Castrol для 2 стрілецького батальйону військової частини А1008.JPG",
    ...
    {
        "name": "2022-06-30_Бронежилет для бійця АЗОВ.JPG",
        "text": "Бронежилет для бійця АЗОВ. 2022-06-30."
    },
    {
        "name": "2022-07-02_Їжа для ЗСУ-Донецька область.JPG",
        "text": "Їжа для ЗСУ. Донецька область., 2022-07-02."
    },
    {
        "name": "2022-07-05_Їжа для ЗСУ-Схід.JPG",
    ...
    {
        "name": "2022-07-14_Амуніція для 210 окремого спец.батальйону «Берлінго»-Схід.JPG",
        "text": "Амуніція для 210 окремого спец.батальйону «Берлінго». Схід, 2022-07-14."
    },
    {
        "name": "2022-07-15_Їжа для бійців у східний напрямок.JPG",
    ...
    {
        "name": "2022-07-19_Їжа для бійців на південому напрямку.JPG",
        "text": "Їжа для бійців на південому напрямку. 2022-07-19."
    },
    {
        "name": "2022-07-22_Павербанки для бійців.JPG",
        "text": "Павербанки для бійців. 2022-07-22."
    },
    {
        "name": "2022-07-23_Майстер-клас для дітей по створенню патріотичних листівок.JPG",
        "text": "Майстер-клас для дітей по створенню патріотичних листівок. 2022-07-23."
    },
    {
        "name": "2022-07-28_Квадрокоптер, планшети, тепловізор  для бійців 110 ОМБ у східному напрямку.JPG",
        "text": "Квадрокоптер, планшети, тепловізор  для бійців 110 ОМБ у східному напрямку. 2022-07-28."
    },
    {
        "name": "2022-07-30_Обладнення для бійців 110 ОМБ на східний напрямок.JPG",
    ...
    {
        "name": "2022-08-13_Їжа для бійців 17 танкової бригади.JPG",
        "text": "Їжа для бійців 17 танкової бригади. 2022-08-13."
    },
    {
        "name": "2022-08-13_Майстер клас по створенню патріотичних листівок від Юлії Полюшко.JPG",
        "text": "Майстер клас по створенню патріотичних листівок від Юлії Полюшко. 2022-08-13."
    },
    {
        "name": "2022-08-13_Тактичне спорядження для 210 окремого спеціалізованого батальйону «Берлінго».JPG",
    ...
    {
        "name": "2022-08-17_Тактичне спорядження для бійця «Азов».JPG",
        "text": "Тактичне спорядження для бійця «Азов». 2022-08-17."
    },
    {
        "name": "2022-08-17_Тактичне спорядження для бійця «Азов»(1).JPG",
        "text": "Тактичне спорядження для бійця «Азов». 2022-08-17."
    },
    {
    ...
    {
        "name": "2022-08-28_Тактичне спорядження для 210 окремого спеціалізованого батальйону «Берлінго».JPG",
        "text": "Тактичне спорядження для 210 окремого спеціалізованого батальйону «Берлінго». 2022-08-28."
    },
    {
        "name": "2022-08-29_Тактичне спорядження для бійця 80 ДШБ.JPG",
        "text": "Тактичне спорядження для бійця 80 ДШБ. 2022-08-29."
    },
    {
        "name": "2022-08-29_Тактичне спорядження для бійця 80 ДШБ(1).JPG",
        "text": "Тактичне спорядження для бійця 80 ДШБ. 2022-08-29."
    },
    {
        "name": "2022-08-31_Тактичне спорядження для бійця у східному напрямку.JPG",
        "text": "Тактичне спорядження для бійця у східному напрямку. 2022-08-31."
    },
    {
        "name": "2022-09-02_Тактичне спорядження для бійця.JPG",
        "text": "Тактичне спорядження для бійця. 2022-09-02."
    },
    {
        "name": "2022-09-04_Тактичне спорядження для бійця 80 ДШБ.JPG",
        "text": "Тактичне спорядження для бійця 80 ДШБ. 2022-09-04."
    },
    {
        "name": "2022-09-19_Провізія для бійців 80 ДШБ.JPG",
        "text": "Провізія для бійців 80 ДШБ. 2022-09-19."
    },
    {
        "name": "2022-09-21_Енергетичні батончики для бійців у південному напрямку.JPG",
        "text": "Енергетичні батончики для бійців у південному напрямку. 2022-09-21."
    },
    {
        "name": "2022-09-23_Провізія для бійців.JPG",
        "text": "Провізія для бійців. 2022-09-23."
    },
    {
        "name": "2022-09-25_Тактичне спорядження для бійців розвідки та Азов.JPG",
        "text": "Тактичне спорядження для бійців розвідки та Азов. 2022-09-25."
    },
    {
        "name": "2022-09-25_Тактичне спорядження для бійців розвідки та Азов(1).JPG",
        "text": "Тактичне спорядження для бійців розвідки та Азов. 2022-09-25."
    },
    {
        "name": "2022-09-25_Тактичне спорядження та провізія для бійців у південному напрямку.JPG",
        "text": "Тактичне спорядження та провізія для бійців у південному напрямку. 2022-09-25."
    },
    {
        "name": "2022-10-31_Тактичне спорядження та провізія для бійців 10 штурмової бригади.JPG",
        "text": "Тактичне спорядження та провізія для бійців 10 штурмової бригади. 2022-10-31."
    },
    {
        "name": "2023-01-08_Провізія та медикаменти  для бійців 125 бригади.JPG",
        "text": "Провізія та медикаменти для бійців 125 бригади. 2023-01-08."
    },
    {
        "name": "2023-01-10_допомога купівлі кіберрук для військового ССО Олександру Кулику.jpg",
    ...
    {
        "name": "2023-03-11_Монокуляр для бійця3 ОШБ.PNG",
        "text": "Монокуляр для бійця3 ОШБ. 2023-03-11."
    },
    {
        "name": "2023-03-23_Провізія  для бійців 4 бригади.JPG",
        "text": "Провізія для бійців 4 бригади. 2023-03-23."
    },
    {
        "name": "2023-04-01_Екіпірування для бійця ДФТГ.JPG",
    ...
    {
        "name": "2023-06-05_пікап для Едельвейс.JPG",
        "text": "Пікап для Едельвейс. 2023-06-05."
    },
    {
        "name": "2023-06-15_зарядна станція та сонячні батареї для ППО.JPG",
        "text": "Зарядна станція та сонячні батареї для ППО. 2023-06-15."
    },
    {
        "name": "2023-07-03_маскувальні сітки для зенітно ракетної бригади.JPG",
    ...
    {
        "name": "2023-10-26_Пікап для воїнів у Запорізькому напрямку.JPG ",
        "text": "Пікап для воїнів у Запорізькому напрямку. 2023-10-26."
    },
    {
        "name": "2023-10-29_Автомобіль для 15 артилерійської бригади «Чорний Ліс».JPG ",
        "text": "Автомобіль для 15 артилерійської бригади «Чорний Ліс». 2023-10-29."
    },
    {
        "name": "2023-11-17_ Буржуйки, рації, теплий одяг, продукти для 24-ї ОМБр.JPG ",
        "text": "Буржуйки, рації, теплий одяг, продукти для 24-ї ОМБр. 2023-11-17."
    },
    {
        "name": "2023-11-17_ Зарядні пристрої, хімічні грілки та продукти для 63-ї ОМБр.JPG ",
        "text": "Зарядні пристрої, хімічні грілки та продукти для 63-ї ОМБр. 2023-11-17."
    },
    {
        "name": "2023-11-17_Буржуйки, рації, теплий одяг, продукти 24-ї ОМБр.JPG ",
        "text": "Буржуйки, рації, теплий одяг, продукти 24-ї ОМБр. 2023-11-17."
    },
    {
        "name": "2023-11-17_дрони для Рарог 24-ї ОМБр.JPG ",
    ...
    {
        "name": "2024-01-13_Провізія для 10 ОГШБ Едельвейс.JPG ",
        "text": "Провізія для 10 ОГШБ Едельвейс. 2024-01-13."
    },
    {
        "name": "2024-01-13_Провізія для 67 ОМБ «Правий Сектор».JPG ",
    ...
    {
        "name": "2024-01-23_Екіпірування для бійця 45-окремої артилерійської бригади.PNG",
        "text": "Екіпірування для бійця 45-окремої артилерійської бригади. 2024-01-23."
    }
]

  const reportsHtml = reportsData.map(item => {
